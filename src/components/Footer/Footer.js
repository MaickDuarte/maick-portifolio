...
export default function Footer() {
  return (
    <footer className="bg-primary-dark py-20 px-6">
        ...
        <div className="grid md:grid-cols-2">
          <div>
            ...
            <div className="flex gap-6 justify-center">
              <Link href="#" className="text-gray-medium hover:text-gray-light hover:scale-110 duration-100 transiction-all">
          ...
          <div>
            <div className="w-max mx-auto p-4">
              ...
              <div className="flex flex-col gap-2">
                ...
                <Link href="#" className="text-gray-medium hover:text-gray-light hover:scale-110 duration-100 transiction-all">
                  <p className="text-lg">+55 (11) 98575-7040</p>
                </Link>
                <Link href="#" className="text-gray-medium hover:text-gray-light hover:scale-110 duration-100 transiction-all">
